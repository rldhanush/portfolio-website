    ...
    ref={ref}
      ...
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        ...
        >
           ...
           href='https://drive.google.com/file/d/1xN643Wk0ffPcAyuehfc7cu5etQEuRXxa/view?usp=sharing' download={true} >Download CV<HiDownload className='opacity-60 group-hover:translate-y-1 transition' /></a>
