      ...
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        <div className="flex items-center justify-center">
            <div className='relative'>
                ...
                >
                    <Image src='/drl_prp.jpg' alt='Profile Picture' width="192" height='192' quality='95' priority={true}
        ...
        >
            <h1 className='text-2xl sm:text-4xl font-bold'>Hello, I&apos;m Dhanush R L</h1>
            <p className='text-lg mt-3'>a software engineer diving deep into <span className='font-bold italic'>Backend development</span> and a <span className='font-bold italic'>Python enthusiast</span>.</p>
            <p className='text-lg mt-3'> Coding <span className='underline'>clean</span>, <span className='underline'>user-friendly solutions</span> is my passion. Off-duty, I&apos;m all about meditation and self-growth.</p>
        </motion.div>
        ...
        >
           ...
           href='https://drive.google.com/file/d/16pX4Ac0cPwG38GoXSNr4UpuQHzCU2YPl/view?usp=drive_link' download={true} >Download CV<HiDownload className='opacity-60 group-hover:translate-y-1 transition' /></a>
            ...
            href='https://www.linkedin.com/in/dhanushrl/' target='_blank'><BsLinkedin /></a>
            
            <a className='bg-white p-4 text-gray-700
            flex items-center gap-2 rounded-full outline-none text-[1.35rem] focus:scale-[1.15] hover:scale-[1.15] 
            hover:text-gray-950 active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60'
            href='https://github.com/rldhanush' target='_blank'><FaGithubSquare/></a>
        </motion.div>
    </section>
  )
}
