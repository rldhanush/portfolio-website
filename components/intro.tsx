    ...
    ref={ref}
      ...
      className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        ...
        >
           ...
           href='https://drive.google.com/uc?export=download&id=1fLyM86tyOSm9NDQ9ta1Ne_4huNAOksTd' download={true} >Download CV<HiDownload className='opacity-60 group-hover:translate-y-1 transition' /></a>
